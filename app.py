...
def auto_format_clip(input_file, output_file, start_time, duration, zoom_width=2400, end_sound=None, progress_callback=None):
    try:
        ...
        if end_sound and os.path.exists(end_sound):
            try:
                sound_probe = ffmpeg.probe(end_sound)
...
class VideoConverterApp:
    def __init__(self, root):
        ...
        self.root.configure(bg="#11111b")  # Sleeker deep obsidian background
    ...
    def build_ui(self):
        ...
        tk.Label(header_frame, text="🎬 Shorts & Reels Studio", font=("Segoe UI", 18, "bold"), bg="#11111b", fg="#b4befe").pack()
        tk.Label(header_frame, text="Convert gameplay clips to premium 9:16 vertical videos", font=("Segoe UI", 10), bg="#11111b", fg="#7f849c").pack(pady=2)
        ...
        ttk.Label(form_frame := form_wrapper, text="Clip End Position:", font=("Segoe UI", 10, "bold"), background="#1e1e2e").grid(row=1, column=0, sticky="w", pady=8)
